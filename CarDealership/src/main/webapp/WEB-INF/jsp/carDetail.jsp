...
<body class="flex-col">
    ...
    <div class="main-content">
            <c:forEach items="${carsByMake}" var="cars">
                <div class="flex-col box">
                    <img class="car-img" src="${cars.image}" alt="">
                    <div class="car-details">
                        ${cars.year}
                        ${cars.make}
                        ${cars.model}
                        <br> Price: ${cars.price}
                        <br> Mileage: ${cars.mileage}
                        <br> Description: ${cars.description}
                    </div>
                    <a class="buy" href="/carDetail/${cars.getId()}">Buy</a>
                </div>
            </c:forEach>
        </div>
     </div> 
